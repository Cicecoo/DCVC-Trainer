...
from src.models.DCVC_net import DCVC_net as DCVC_net_val
...
if __name__ == "__main__": 
    ...
    for epoch in range(train_args['epochs']):
        ...
        # save model
        current_save_path = os.path.join(save_folder, f"model_epoch_{epoch}.pth")
        torch.save(trainer.video_net.state_dict(), current_save_path)
